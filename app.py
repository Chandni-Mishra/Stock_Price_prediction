...
def apple():
    ...
    name = 'Apple'
    return render_template('second_page.html',title='APPLE',name = name,combine=combine,Forecasting_DATA=Forecasting_DATA,DATASET=DATASET,WINDOWED_DATA=WINDOWED_DATA,TEST_TRAIN_DATA = TEST_TRAIN_SPLIT,PREDICTED_DATA=PREDICTED_DATA)
...
def google():
    ...
    name = 'Google'
    return render_template('second_page.html',title='Google',name = name,combine=combine,Forecasting_DATA=Forecasting_DATA,DATASET=DATASET,WINDOWED_DATA=WINDOWED_DATA,TEST_TRAIN_DATA = TEST_TRAIN_SPLIT,PREDICTED_DATA=PREDICTED_DATA)
...
def microsoft():
    ...
    name = 'Microsoft'
    return render_template('second_page.html',title='Microsoft',name = name,combine=combine,Forecasting_DATA=Forecasting_DATA,DATASET=DATASET,WINDOWED_DATA=WINDOWED_DATA,TEST_TRAIN_DATA = TEST_TRAIN_SPLIT,PREDICTED_DATA=PREDICTED_DATA)
