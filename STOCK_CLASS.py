...
class STOCK:
    ...
    def plotted_data(self,type):
        ...
        path = 'C:\\stock price prediction\\STOCK_PRICE_PREDICTON\\static\\' + type + '_PLOTTED_DATA.png'
        fig.savefig(path)
        plt.close(fig)
    ...
    def plot_prediction(self,type):
        ...
        path = 'C:\\stock price prediction\\STOCK_PRICE_PREDICTON\\static\\' + type + '_PREDICTED_DATA.png'
        fig.savefig(path)
        plt.close(fig)
    ...
    def forecast(self,type):     
        ...
        path = 'C:\\stock price prediction\\STOCK_PRICE_PREDICTON\\static\\'+ type + '_FORECASTING_DATA.png'
        fig.savefig(path)
        plt.close(fig)
